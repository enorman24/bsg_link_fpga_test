...
//
// PHY selection:
//   Synthesis: uses the UltraScale+ hard PHY
//     (basejump_stl/hard/ultrascale_plus/bsg_link/) which instantiates ODDRE1
//     and IDELAYE3 primitives.  bsg_link_ddr_upstream requires io_clk90_i, a
//     90°-phase-shifted copy of io_clk_i generated by clk_wiz_0 CLKOUT2.
//   Simulation (+define+SIM): uses the generic RTL PHY
//     (basejump_stl/bsg_link/) which avoids Xilinx IO primitives.
//     io_clk90_i is not connected in this path.
//
